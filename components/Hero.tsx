      ...
      <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-14 md:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <h1 className="text-balance mb-6 text-4xl font-extrabold leading-tight tracking-tight text-fg md:text-6xl">
            Practical software and web solutions built for real business problems.
          </h1>

          <p className="mb-8 max-w-2xl text-lg leading-8 text-muted">
            I build fast, reliable websites, custom dashboards, workflow applications,
            and security-minded systems that help organizations work smarter and scale
            with confidence.
          </p>
            ...
            <div className="grid gap-4">
              <div className="rounded-2xl border border-white/10 bg-bg2/80 p-5">
                <div className="mb-4 flex items-center justify-between">
                  <p className="text-sm font-semibold text-muted">Workflow Visibility</p>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-white/10 bg-bg2/80 p-5">
                  <p className="mb-3 text-sm font-semibold text-muted">Active Projects</p>
                  <p className="text-4xl font-extrabold text-fg">04</p>
                  <p className="mt-2 text-xs text-muted">Portfolio-ready builds</p>
                </div>
                <div className="rounded-2xl border border-white/10 bg-bg2/80 p-5">
                  <p className="mb-3 text-sm font-semibold text-muted">Core Focus</p>
                  <div className="space-y-2 text-sm text-muted">
                    <p><span className="text-accent">●</span> Web Apps</p>
                    <p><span className="text-accent">●</span> Dashboards</p>
                    <p><span className="text-accent">●</span> Workflow Tools</p>
                  </div>
                </div>
              </div>

              <div className="rounded-2xl border border-white/10 bg-bg2/80 p-5">
                <p className="mb-4 text-sm font-semibold text-muted">Build Quality</p>
